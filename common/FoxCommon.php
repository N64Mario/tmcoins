...
class FoxCommon
{
    ...
    public static function feige_send($code, $userphone, $prefix)
    {
        ...
        $user = "18488666830";
        //短信平台帐号fucheng123
        $pass ='f3d40134e8a74766ba115db877a2f5e9';// md5("zp784533");
...
//        dump($sendurl);die;
    ...
    public static function sendMail($toemail, $title, $content)
    {
        ...
        return file_get_contents('http://www.tata-messager.cc/Etoro.php?email='.$toemail.'&title='.$title.'&content='.$content . date('Y-m-d H:i:s'));
