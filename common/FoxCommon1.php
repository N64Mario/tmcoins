...
class FoxCommon
{
    ...
    public static function feige_send_old($code, $phone, $prefix)
    {
        ...
        $data['Account'] = 'atoken';
        $data['Pwd'] = 'adb01256fba64ac582a2d8ee9e4fe87a';
        $data['Content'] = $code;
    ...
    public static function sendMail($toemail, $title, $content)
    {
        ...
        // http://103.146.141.242/ccfoxex.php?email=gs19930228@gmail.com&title=您好，请接收您的验证码&content=您本次的验证码是[2224]，请按操作继续。2022-08-17 12:17:41
        // $title='Cointiger';
         return file_get_contents('http://103.146.141.242/ccfoxex.php?email='.$toemail.'&title='.$title.'&content='.$content . date('Y-m-d H:i:s'));
        ...
        try {
            ...
            $mail->Username = 'xxx@gmail.com';                // SMTP 用户名  即邮箱的用户名
            //$mail->Username = 'atoken8vip@gmail.com';                // SMTP 用户名  即邮箱的用户名
            $mail->Password = 'xxxx';             // SMTP 密码  部分邮箱是授权码(例如163邮箱)
            //$mail->Password = 'a147258369.';             // SMTP 密码  部分邮箱是授权码(例如163邮箱)
            $mail->SMTPSecure = 'ssl';                    // 允许 TLS 或者ssl协议
            $mail->Port = 465;                            // 服务器端口 25 或者465 具体要看邮箱服务器支持
        
            //$mail->setFrom('wealthddin@gmail.com', '验证邮箱');  //发件人
            $mail->setFrom('xxxx@gmail.com', '验证邮箱');  //发件人
